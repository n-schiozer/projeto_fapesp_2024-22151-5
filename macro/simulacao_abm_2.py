...
def simul_abm(
    ...
    setores = ci["setores"]
    firmas_base = resultado_inicializacao["firmas"].copy()
    importadores_base = resultado_inicializacao["fornecedores_importados"].copy()
    parametros_setoriais = resultado_inicializacao["parametros_setoriais"]
    tecnologias = resultado_inicializacao["tecnologias_firmas"]
    ...
    importacoes_periodos = {
        0: (
            ...
            * (ci["conversao_de_pm_pb"] @ ci["producao_comprador_base"])
    ...
    for t in range(1, periodos + 1):
        ...
        preco_importacoes = preco_importacoes * ( 1.0 + variacao_importacoes )
